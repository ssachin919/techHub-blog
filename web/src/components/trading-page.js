...
const TradingPage2 = () => {
  ...
  <header className="header" data-header>
    <div className="container">
      ...
      <a href="https://coinslive.org" className="logo">
        <StaticImage src="../images/coinslive.svg" width="32" height="32" alt="Coinslive logo"/>
        DeX
      </a>
      ...
      <section className="section hero" aria-label="hero" data-section>
        <div className="container">
          ...
          <div className="hero-content">
            ...
            <h1 className="h1 hero-title">Buy & Sell Digital Assets In The DeX</h1>

            <p className="hero-text">
              DeX  is the easiest, safest, and fastest way to buy & sell crypto asset exchange.
            </p>
          ...
          <figure className="hero-banner">
            <StaticImage src="../images/hero-banner.png" width="570" height="448" alt="hero banner" className="w-100"/>
          </figure>
            ...
            <ul className="tab-content">
              ...
              <li>
                <div className="trend-card">
                  ...
                  <div className="card-title-wrapper">
                    <StaticImage src="../images/coin-1.svg" width="24" height="24" alt="bitcoin logo"/>
              ...
              <li>
                <div className="trend-card active">
                  ...
                  <div className="card-title-wrapper">
                    <StaticImage src="../images/coin-2.svg" width="24" height="24" alt="ethereum logo"/>
              ...
              <li>
                <div className="trend-card">
                  ...
                  <div className="card-title-wrapper">
                    <StaticImage src="../images/coin-3.svg" width="24" height="24" alt="tether logo"/>
              ...
              <li>
                <div className="trend-card">
                  ...
                  <div className="card-title-wrapper">
                    <StaticImage src="../images/coin-4.svg" width="24" height="24" alt="bnb logo"/>
            ...
            <table className="market-table">
              ...
              <tbody className="table-body">
                ...
                <tr className="table-row">
                  ...
                  <td className="table-data">
                    <div className="wrapper">
                      <StaticImage src="../images/coin-1.svg" width="20" height="20" alt="Bitcoin logo" className="img"/>
                  ...
                  <td className="table-data">
                    <StaticImage src="../images/chart-1.svg" width="100" height="40" alt="profit chart" className="chart"/>
                  </td>
                ...
                <tr className="table-row">
                  ...
                  <td className="table-data">
                    <div className="wrapper">
                      <StaticImage src="../images/coin-2.svg" width="20" height="20" alt="Ethereum logo" className="img"/>
                  ...
                  <td className="table-data">
                    <StaticImage src="../images/chart-2.svg" width="100" height="40" alt="loss chart" className="chart"/>
                  </td>
                ...
                <tr className="table-row">
                  ...
                  <td className="table-data">
                    <div className="wrapper">
                      <StaticImage src="../images/coin-3.svg" width="20" height="20" alt="Tether logo" className="img"/>
                ...
                <tr className="table-row">
                  ...
                  <td className="table-data">
                    <div className="wrapper">
                      <StaticImage src="../images/coin-4.svg" width="20" height="20" alt="BNB logo" className="img"/>
                ...
                <tr className="table-row">
                  ...
                  <td className="table-data">
                    <div className="wrapper">
                      <StaticImage src="../images/coin-5.svg" width="20" height="20" alt="Solana logo" className="img"/>
                ...
                <tr className="table-row">
                  ...
                  <td className="table-data">
                    <div className="wrapper">
                      <StaticImage src="../images/coin-6.svg" width="20" height="20" alt="XRP logo" className="img"/>
                ...
                <tr className="table-row">
                  ...
                  <td className="table-data">
                    <div className="wrapper">
                      <StaticImage src="../images/coin-7.svg" width="20" height="20" alt="Cardano logo" className="img"/>
                ...
                <tr className="table-row">
                  ...
                  <td className="table-data">
                    <div className="wrapper">
                      <StaticImage src="../images/coin-8.svg" width="20" height="20" alt="Avalanche logo" className="img"/>
      ...
      <section className="section instruction" aria-label="instruction" data-section>
        <div className="container">
          ...
          <p className="section-text">
            DeX is a production-ready library of stackable content blocks built in React Native.
          </p>
          ...
          <ul className="instruction-list">
            ...
            <li>
              <div className="instruction-card">
                ...
                <figure className="card-banner">
                  <StaticImage src="../images/instruction-1.png" width="96" height="96" loading="lazy" alt="Step 1"
                    className="img"/>
                </figure>
            ...
            <li>
              <div className="instruction-card">
                ...
                <figure className="card-banner">
                  <StaticImage src="../images/instruction-2.png" width="96" height="96" loading="lazy" alt="Step 2"
                    className="img"/>
                </figure>
            ...
            <li>
              <div className="instruction-card">
                ...
                <figure className="card-banner">
                  <StaticImage src="../images/instruction-3.png" width="96" height="96" loading="lazy" alt="Step 3"
                    className="img"/>
                </figure>
            ...
            <li>
              <div className="instruction-card">
                ...
                <figure className="card-banner">
                  <StaticImage src="../images/instruction-4.png" width="96" height="96" loading="lazy" alt="Step 4"
                    className="img"/>
                </figure>
      ...
      <section className="section about" aria-label="about" data-section>
        <div className="container">
          ...
          <figure className="about-banner">
            <StaticImage src="../images/about-banner.png" width="748" height="436" loading="lazy" alt="about banner"
              className="w-100"/>
          </figure>

          <div className="about-content">

            <h2 className="h2 section-title">What Is DeX</h2>
        ...
        <div className="container">
          ...
          <div className="app-content">
            ...
            <div className="app-wrapper">
              <a href="#">
                <StaticImage src="../images/googleplay.png" width="135" height="40" loading="lazy"
                  alt="get it on google play"/>
              </a>

              <a href="#">
                <StaticImage src="../images/appstore.png" width="120" height="40" loading="lazy"
          ...
          <div className="app-banner">
            <StaticImage src="../images/app-banner.png" width="618" height="526" loading="lazy" alt="app banner"
              className="w-100"/>
    ...
    <div className="footer-top" data-section>
      <div className="container">
        ...
        <div className="footer-brand">
          ...
          <a href="https://coinslive.org" className="logo">
            <StaticImage src="../images/coinslive.svg" width="50" height="50" alt="coinslive logo" />
            DeX
          </a>

          <h2 className="footer-title">Let's talk! 🤙</h2>

          <a href="tel:+913456789101" className="footer-contact-link">+12 345 678 9101</a>

          <a href="mailto:coinslive.org@gmail.com" className="footer-contact-link">coinslive.org@gmail.com</a>
        ...
        <ul className="footer-list">
          ...
          <li>
            <a href="#" className="footer-link">BuyBit Learn</a>
          </li>
        ...
        <ul className="footer-list">
          ...
          <li>
            <a href="#" className="footer-link">About BuyBit</a>
          </li>
    ...
    <div className="footer-bottom">
      <div className="container">
        ...
        <p className="copyright">
          &copy; 2022 DeX All Rights Reserved by <a href="#" className="copyright-link">coinslive.org</a>
        </p>
